...
<body>
            ...
            <div class="float-right">
                <table>
                    <tr>
                        ...
                        <td>:</td>
                        <td><?php echo $pengajuan->tanggal_pengajuan_internal ?></td>
                    </tr>
                    <tr>
                    ...
                    <tbody> 
                        ...
                        <?php foreach($items as $item) : ?>
                            <?php 
                                ...
                                $subtotal = $item->pengajuan_internal_actual_qty * $item->pengajuan_internal_actual_price;
                                
                            ?>
                            <tr>
                                <td class="text-center"><?php echo ++$no; ?></td>
                                <td class="text-center"><?php echo $item->pengajuan_internal_name ?></td>
                                <td class="text-center"><?php echo $item->pengajuan_internal_actual_qty; ?> <?php echo $item->pengajuan_internal_unit; ?></td>
                                <td class="text-right"><?php echo number_format($item->pengajuan_internal_actual_price); ?></td>
                                <td class="text-right"><?php echo number_format($subtotal) ?></td>
                                <td class="text-center"><?php echo $item->pengajuan_internal_actual_keterangan; ?></td>
                            </tr>
                        <?php endforeach; ?>
    ...
    <div class="clearfix mt-3">
        ...
        <?php foreach($penanggung_jawab as $penanggung) :  ?>
            <?php  if($penanggung->penanggung_jawab_user != $pengajuan->id_pengaju) : ?>
            <div class="float-left col-4">
