...
<html lang="en">
  ...
  <body>
    ...
    <?php 
        ...
        $pecahkan = explode('-', $pengajuan['tanggal_pengajuan_internal']);
        $validasi_date = $pecahkan[2] . ' ' . $bulan[ (int)$pecahkan[1] ] . ' ' . $pecahkan[0];

        $pecahkan_due_date = explode('-', $pengajuan['due_date_pengajuan_internal']);
        ...
        <div class="float-left">
            <table>
                ...
                <tr>
                    <td>Perihal</td>
                    <td>:</td>
                    <td><?php echo $pengajuan['perihal_pengajuan_internal'] ?></td>
                </tr>
                <tr>
                    <td>Nomor</td>
                    <td>:</td>
                    <td><?php echo $pengajuan['no_surat_pengajuan_internal'] ?></td>
                </tr>
            </table>
        </div>
        ...
        <table class="table table-bordered table-sm">
            ...
            <tbody>
                ...
                <?php foreach($items as $item) : ?>
                    ...
                    $subtotal = $item->pengajuan_internal_qty * $item->pengajuan_internal_price;
                    $total += $subtotal;
                    ...
                    <tr>
                        ...
                        <td>
                            <div><?php echo $item->pengajuan_internal_name ?></div>
                            <small><?php echo $item->pengajuan_internal_desc ?></small>
                    
                        </td>
                        <td class="text-center" width="50"><?php echo $item->pengajuan_internal_qty ?> <?php echo $item->pengajuan_internal_unit ?></td>
                        <td class="text-right"><?php echo number_format($item->pengajuan_internal_price) ?></td>
                        <td class="text-right"><?php echo number_format($subtotal) ?></td>
                        <td><?php echo $item->pengajuan_internal_keterangan ?></td>
                    </tr>
